...
if.then:                                          ; preds = %for.body
  ...
  %call17 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %12)
  %13 = load ptr, ptr %result, align 8
  %arrayidx18 = getelementptr inbounds %struct.nodeOneOld, ptr %13, i64 5000
  %f = getelementptr inbounds %struct.nodeOneOld, ptr %arrayidx18, i32 0, i32 5
  %14 = load double, ptr %f, align 8
  %call19 = call i32 (ptr, ...) @printf(ptr noundef @.str.2, double noundef %14)
  br label %if.end
