...
%struct.nodeOneOld = type { i32, double, i32, ptr, ptr }
...
for.body:                                         ; preds = %for.cond
  ...
  %cold = getelementptr inbounds %struct.nodeOneOld, ptr %arrayidx6, i32 0, i32 3
  ...
  %cold9 = getelementptr inbounds %struct.nodeOneOld, ptr %arrayidx8, i32 0, i32 3
  ...
  %arrayidx11 = getelementptr inbounds %struct.nodeOneOld, ptr %13, i64 %idxprom10
  %cold12 = getelementptr inbounds %struct.nodeOneOld, ptr %arrayidx11, i32 0, i32 3
  ...
  %arrayidx14 = getelementptr inbounds %struct.nodeOneOld, ptr %16, i64 %idxprom13
  %cold15 = getelementptr inbounds %struct.nodeOneOld, ptr %arrayidx14, i32 0, i32 3
  ...
  %cold18 = getelementptr inbounds %struct.nodeOneOld, ptr %arrayidx17, i32 0, i32 3
...
for.body:                                         ; preds = %for.cond
  ...
  %idxprom = sext i32 %3 to i64
  %arrayidx = getelementptr inbounds %struct.nodeOneOld, ptr %2, i64 %idxprom
  %cold = getelementptr inbounds %struct.nodeOneOld, ptr %arrayidx, i32 0, i32 3
