...
for.body:                                         ; preds = %for.cond
  ...
  store i64 %bf.set, ptr %b20, align 8
...
for.body3:                                        ; preds = %for.cond1
  ...
  %bf.set = or i64 %bf.clear, %bf.value
  store i64 %bf.set, ptr %b12, align 8
  %bf.result.shl = shl i64 %bf.value, 16
  %bf.result.ashr = ashr i64 %bf.result.shl, 16
  %9 = load ptr, ptr %arrayOne.addr, align 8
  %10 = load i32, ptr %i, align 4
  %idxprom14 = sext i32 %10 to i64
  %arrayidx15 = getelementptr inbounds %struct.nodeOneOld, ptr %9, i64 %idxprom14
  %e = getelementptr inbounds %struct.nodeOneOld, ptr %arrayidx15, i32 0, i32 2
  store i8 102, ptr %e, align 8
  %11 = load ptr, ptr %arrayTwo.addr, align 8
  %12 = load i32, ptr %i, align 4
  %idxprom16 = sext i32 %12 to i64
  %arrayidx17 = getelementptr inbounds %struct.nodeOneOld, ptr %11, i64 %idxprom16
...
if.then:                                          ; preds = %for.body
  ...
  %arrayidx = getelementptr inbounds %struct.nodeOneOld, ptr %13, i64 10
  %a = getelementptr inbounds %struct.nodeOneOld, ptr %arrayidx, i32 0, i32 0
  %14 = load double, ptr %a, align 8
  %call7 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, double noundef %14)
  %15 = load ptr, ptr %arrayOneOld, align 8
  %arrayidx8 = getelementptr inbounds %struct.nodeOneOld, ptr %15, i64 10
  %b = getelementptr inbounds %struct.nodeOneOld, ptr %arrayidx8, i32 0, i32 1
  %bf.load = load i64, ptr %b, align 8
  %bf.shl = shl i64 %bf.load, 16
  %bf.ashr = ashr i64 %bf.shl, 16
  %call9 = call i32 (ptr, ...) @printf(ptr noundef @.str.2, i64 noundef %bf.ashr)
  %16 = load ptr, ptr %arrayOneOld, align 8
  %arrayidx10 = getelementptr inbounds %struct.nodeOneOld, ptr %16, i64 10
  %c = getelementptr inbounds %struct.nodeOneOld, ptr %arrayidx10, i32 0, i32 3
  %17 = load i32, ptr %c, align 8
  %call11 = call i32 (ptr, ...) @printf(ptr noundef @.str.3, i32 noundef %17)
  %18 = load ptr, ptr %arrayOneOld, align 8
  %arrayidx12 = getelementptr inbounds %struct.nodeOneOld, ptr %18, i64 10
  %d = getelementptr inbounds %struct.nodeOneOld, ptr %arrayidx12, i32 0, i32 4
  %19 = load i32, ptr %d, align 4
  %call13 = call i32 (ptr, ...) @printf(ptr noundef @.str.4, i32 noundef %19)
  %20 = load ptr, ptr %arrayOneOld, align 8
  %arrayidx14 = getelementptr inbounds %struct.nodeOneOld, ptr %20, i64 10
  %e = getelementptr inbounds %struct.nodeOneOld, ptr %arrayidx14, i32 0, i32 2
  %21 = load i8, ptr %e, align 8
  %conv15 = sext i8 %21 to i32
  %call16 = call i32 (ptr, ...) @printf(ptr noundef @.str.5, i32 noundef %conv15)
  br label %if.end
