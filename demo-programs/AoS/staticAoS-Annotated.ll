...
%struct.nodeOne = type { i32, i32, i8 } //struct for each array elements in AoS
...
define dso_local i32 @main() #0 { //main function
  %1 = alloca i32, align 4 //used for return 0;
  %2 = alloca i32, align 4 //used for array size
  %3 = alloca ptr, align 8 
  %4 = alloca i64, align 8
  store i32 0, ptr %1, align 4
  store i32 697000, ptr %2, align 4 //size of array

  %5 = load i32, ptr %2, align 4
  %6 = zext i32 %5 to i64
  %7 = call ptr @llvm.stacksave.p0() //saves current stack contents
  store ptr %7, ptr %3, align 8

  %8 = alloca %struct.nodeOne, i64 %6, align 16 //static array created of size 697000

  store i64 %6, ptr %4, align 8
  store i32 0, ptr %1, align 4
  %9 = load ptr, ptr %3, align 8
  call void @llvm.stackrestore.p0(ptr %9) //restores stack contents
