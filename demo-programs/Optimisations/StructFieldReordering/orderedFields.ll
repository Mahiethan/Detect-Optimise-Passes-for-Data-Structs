...
for.body:                                         ; preds = %for.cond
  ...
  %a = getelementptr inbounds %struct.nodeOneOld, ptr %arrayidx2, i32 0, i32 1
  ...
  %b13 = getelementptr inbounds %struct.nodeOneOld, ptr %arrayidx12, i32 0, i32 0
...
for.body:                                         ; preds = %for.cond
  ...
  %call = call noalias ptr @calloc(i64 noundef %conv, i64 noundef 16) #5
  ...
  call void @populateNodeOneOld(ptr noundef %6, i32 noundef %7)
  %8 = load ptr, ptr %arrayTwoOld, align 8
  %9 = load i32, ptr %n, align 4
  call void @populateNodeOneOld(ptr noundef %8, i32 noundef %9)
  %10 = load ptr, ptr %arrayOneOld, align 8
  %11 = load i32, ptr %n, align 4
  call void @multNodeOneOld(ptr noundef %10, i32 noundef %11)
  %12 = load ptr, ptr %arrayOneOld, align 8
  %13 = load ptr, ptr %arrayTwoOld, align 8
  %14 = load i32, ptr %n, align 4
  call void @multArrays(ptr noundef %12, ptr noundef %13, i32 noundef %14)
  %15 = load i32, ptr %i, align 4
  %cmp3 = icmp eq i32 %15, 79
  br i1 %cmp3, label %if.then, label %if.end

if.then:                                          ; preds = %for.body
  %call5 = call i32 (ptr, ...) @printf(ptr noundef @.str)
  %16 = load ptr, ptr %arrayOneOld, align 8
  %arrayidx = getelementptr inbounds %struct.nodeOneOld, ptr %16, i64 1
  %a = getelementptr inbounds %struct.nodeOneOld, ptr %arrayidx, i32 0, i32 1
  %17 = load i32, ptr %a, align 8
  %call6 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %17)
  %18 = load ptr, ptr %arrayOneOld, align 8
  %arrayidx7 = getelementptr inbounds %struct.nodeOneOld, ptr %18, i64 1
  %b = getelementptr inbounds %struct.nodeOneOld, ptr %arrayidx7, i32 0, i32 0
  %19 = load double, ptr %b, align 8
  %call8 = call i32 (ptr, ...) @printf(ptr noundef @.str.2, double noundef %19)
  %20 = load ptr, ptr %arrayOneOld, align 8
  %arrayidx9 = getelementptr inbounds %struct.nodeOneOld, ptr %20, i64 1
  %c = getelementptr inbounds %struct.nodeOneOld, ptr %arrayidx9, i32 0, i32 2
  %21 = load i8, ptr %c, align 8
  ...
  %arrayidx12 = getelementptr inbounds %struct.nodeOneOld, ptr %22, i64 1
...
if.end:                                           ; preds = %if.then, %for.body
  %24 = load ptr, ptr %arrayOneOld, align 8
