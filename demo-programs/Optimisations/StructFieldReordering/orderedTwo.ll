...
entry:
  ...
  store ptr %3, ptr %arrayOneOld, align 8
  ...
  store ptr %7, ptr %arrayTwoOld, align 8
  ...
  call void @populateNodeOneOld(ptr noundef %10, i32 noundef %11)
  %12 = load ptr, ptr %arrayOneOld, align 8
  %13 = load i32, ptr %n, align 4
  call void @multNodeOneOld(ptr noundef %12, i32 noundef %13)
  %14 = load ptr, ptr %arrayOneOld, align 8
  %15 = load ptr, ptr %arrayTwoOld, align 8
  %16 = load i32, ptr %n, align 4
  call void @multArrays(ptr noundef %14, ptr noundef %15, i32 noundef %16)
  %call4 = call i32 (ptr, ...) @printf(ptr noundef @.str)
  %17 = load ptr, ptr %arrayOneOld, align 8
  %arrayidx = getelementptr inbounds %struct.nodeOneOld, ptr %17, i64 10
  %a = getelementptr inbounds %struct.nodeOneOld, ptr %arrayidx, i32 0, i32 0
  %18 = load double, ptr %a, align 8
  %call5 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, double noundef %18)
  %19 = load ptr, ptr %arrayOneOld, align 8
  %arrayidx6 = getelementptr inbounds %struct.nodeOneOld, ptr %19, i64 10
  ...
  %arrayidx8 = getelementptr inbounds %struct.nodeOneOld, ptr %20, i64 10
  %c = getelementptr inbounds %struct.nodeOneOld, ptr %arrayidx8, i32 0, i32 3
  %21 = load i32, ptr %c, align 8
  %call9 = call i32 (ptr, ...) @printf(ptr noundef @.str.3, i32 noundef %21)
  %22 = load ptr, ptr %arrayOneOld, align 8
  %arrayidx10 = getelementptr inbounds %struct.nodeOneOld, ptr %22, i64 10
  %d = getelementptr inbounds %struct.nodeOneOld, ptr %arrayidx10, i32 0, i32 4
  %23 = load i32, ptr %d, align 4
  %call11 = call i32 (ptr, ...) @printf(ptr noundef @.str.4, i32 noundef %23)
  %24 = load ptr, ptr %arrayOneOld, align 8
  %arrayidx12 = getelementptr inbounds %struct.nodeOneOld, ptr %24, i64 10
