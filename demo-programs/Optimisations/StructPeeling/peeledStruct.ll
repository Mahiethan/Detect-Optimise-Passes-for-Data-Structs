...
if.then:                                          ; preds = %for.body
  ...
  %6 = getelementptr inbounds [999999 x %struct.nodeOneOld], ptr @arrayOneOld, i64 0, i64 5000
  %7 = getelementptr inbounds %struct.nodeOneOld, ptr %6, i32 0, i32 0
  %8 = load i32, ptr %7, align 4
  %call2 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %8)
  %9 = getelementptr inbounds [999999 x %struct.nodeOneOld], ptr @arrayOneOld, i64 0, i64 5000
  %10 = getelementptr inbounds %struct.nodeOneOld, ptr %9, i32 0, i32 1
