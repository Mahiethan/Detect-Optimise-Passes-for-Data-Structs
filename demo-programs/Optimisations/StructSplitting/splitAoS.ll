...
if.then:                                          ; preds = %for.body
  ...
  %d = getelementptr inbounds %struct.nodeOneCold, ptr %18, i32 0, i32 1
  %19 = load double, ptr %d, align 8
  %call11 = call i32 (ptr, ...) @printf(ptr noundef @.str.2, double noundef %19)
  %20 = load ptr, ptr %arrayOneHot, align 8
  %arrayidx12 = getelementptr inbounds %struct.nodeOneOld, ptr %20, i64 5
  %cold13 = getelementptr inbounds %struct.nodeOneOld, ptr %arrayidx12, i32 0, i32 2
  %21 = load ptr, ptr %cold13, align 8
  %e = getelementptr inbounds %struct.nodeOneCold, ptr %21, i32 0, i32 2
...
if.end:                                           ; preds = %if.then, %for.body
  %23 = load ptr, ptr %arrayOneHot, align 8
