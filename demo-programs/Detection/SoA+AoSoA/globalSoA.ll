...
entry:
  ...
  %aos = alloca [12 x %struct.test], align 16
  ...
  %arrayidx = getelementptr inbounds [12 x %struct.test], ptr %aos, i64 0, i64 2
  %a = getelementptr inbounds %struct.test, ptr %arrayidx, i32 0, i32 0
  store i32 123, ptr %a, align 16
  ...
  %2 = load ptr, ptr @globalFour, align 8
  call void @free(ptr noundef %2) #5
