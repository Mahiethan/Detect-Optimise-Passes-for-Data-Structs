...
%struct.StructureOne = type { [1000 x i32], [2000 x i32], [3000 x i8] }
%struct.StructureTwo = type { [1000 x i32], [2000 x i32], i8 }
...
for.body3:                                        ; preds = %for.cond1
  ...
  %arrayidx5 = getelementptr inbounds [2000 x i32], ptr %b, i64 0, i64 %idxprom4
...
for.body11:                                       ; preds = %for.cond9
  ...
  %arrayidx13 = getelementptr inbounds [3000 x i8], ptr %c, i64 0, i64 %idxprom12
...
for.end16:                                        ; preds = %for.cond9
  call void @llvm.memcpy.p0.p0.i64(ptr align 4 %agg.result, ptr align 8 %soa, i64 15000, i1 false)
  ret void
}
...
entry:
  ...
  %call = call noalias ptr @malloc(i64 noundef 15000) #5
...
for.body5:                                        ; preds = %for.cond3
  ...
  %arrayidx7 = getelementptr inbounds [2000 x i32], ptr %b, i64 0, i64 %idxprom6
...
for.body15:                                       ; preds = %for.cond13
  ...
  %arrayidx17 = getelementptr inbounds [3000 x i8], ptr %c, i64 0, i64 %idxprom16
...
entry:
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr align 4 %s4, ptr align 4 %tmp, i64 15000, i1 false)
...
entry:
  ...
  %arrayidx8 = getelementptr inbounds [1000 x i32], ptr %a7, i64 0, i64 0
  store i32 10, ptr %arrayidx8, align 8
  %a9 = getelementptr inbounds %struct.StructureOne, ptr %s1, i32 0, i32 0
  %arrayidx10 = getelementptr inbounds [1000 x i32], ptr %a9, i64 0, i64 0
  ...
  %arrayidx12 = getelementptr inbounds [1000 x i32], ptr %a11, i64 0, i64 0
