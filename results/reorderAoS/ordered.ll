...
%struct.nodeFour = type { [111 x float], [4 x i8], [11 x i32], [1 x i32] }
...
for.body4:                                        ; preds = %for.cond1
  ...
  %bf.load = load i48, ptr %b, align 8
  %bf.cast = sext i48 %bf.load to i64
  %conv5 = sitofp i64 %bf.cast to double
  ...
  %15 = trunc i64 %conv15 to i48
  store i48 %15, ptr %b18, align 8
  %bf.result.cast = sext i48 %15 to i64
  br label %for.inc
...
for.body4:                                        ; preds = %for.cond1
  ...
  %bf.load8 = load i48, ptr %b7, align 8
  %bf.cast9 = sext i48 %bf.load8 to i64
  %mul = mul nsw i64 %bf.cast, %bf.cast9
  %7 = load ptr, ptr %arrayOne.addr, align 8
  %8 = load i32, ptr %i, align 4
  %idxprom10 = sext i32 %8 to i64
  %arrayidx11 = getelementptr inbounds %struct.nodeTwo, ptr %7, i64 %idxprom10
  %b12 = getelementptr inbounds %struct.nodeTwo, ptr %arrayidx11, i32 0, i32 1
  %9 = trunc i64 %mul to i48
  store i48 %9, ptr %b12, align 8
  %bf.result.cast = sext i48 %9 to i64
  %10 = load i8, ptr %randomletter, align 1
  %11 = load ptr, ptr %arrayOne.addr, align 8
  %12 = load i32, ptr %i, align 4
  %idxprom13 = sext i32 %12 to i64
  %arrayidx14 = getelementptr inbounds %struct.nodeTwo, ptr %11, i64 %idxprom13
  %e = getelementptr inbounds %struct.nodeTwo, ptr %arrayidx14, i32 0, i32 2
  store i8 %10, ptr %e, align 2
  br label %for.inc
...
for.body3:                                        ; preds = %for.cond1
  ...
  %a = getelementptr inbounds %struct.nodeFour, ptr %arrayidx, i32 0, i32 2
  %6 = load i32, ptr %i, align 4
...
for.body8:                                        ; preds = %for.cond6
  ...
  %b = getelementptr inbounds %struct.nodeFour, ptr %arrayidx10, i32 0, i32 0
  %12 = load i32, ptr %i, align 4
  %idxprom11 = sext i32 %12 to i64
...
for.body19:                                       ; preds = %for.cond16
  ...
  %c = getelementptr inbounds %struct.nodeFour, ptr %arrayidx21, i32 0, i32 1
...
for.body3:                                        ; preds = %for.cond1
  ...
  %a8 = getelementptr inbounds %struct.nodeFour, ptr %arrayidx7, i32 0, i32 2
  %9 = load i32, ptr %i, align 4
  %idxprom9 = sext i32 %9 to i64
...
for.body13:                                       ; preds = %for.cond11
  ...
  %a16 = getelementptr inbounds %struct.nodeFour, ptr %arrayidx15, i32 0, i32 2
  %15 = load i32, ptr %i, align 4
  ...
  %b = getelementptr inbounds %struct.nodeFour, ptr %arrayidx20, i32 0, i32 0
  %19 = load i32, ptr %i, align 4
...
for.end26:                                        ; preds = %for.cond11
  ...
  %a29 = getelementptr inbounds %struct.nodeFour, ptr %arrayidx28, i32 0, i32 2
