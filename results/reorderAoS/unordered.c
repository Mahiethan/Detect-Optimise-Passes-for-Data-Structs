...
struct nodeOne //Total size: 24 bytes 
{
    /////////////////////// Word 1
    int a; // 4 bytes
    // 4 byte padding
...
struct nodeTwo //Total size: 32 bytes
{
    /////////////////////// Word 1
    double a; // 8 bytes
    /////////////////////// Word 2
...
struct nodeThree //Total size: 416 bytes
{
    /////////////////////// Word 1
    int a; // 4 bytes
    // 4 bytes padding
    ...
    /////////////////////// Word 3
    int c; // 4 bytes
    float d[96]; // 4 bytes here, rest through word lines 4-52
    /////////////////////// Word 4
    // ...
    /////////////////////// Word 52
    // last 8 bytes of 'float d[97]' here
    //////////////////////
};
...
struct nodeFour // Total size: 496 bytes
{
    /////////////////////// Word 1
    // ...
    /////////////////////// Word 5
    int a[11]; // 44 bytes (through word lines 1-5)
    float b[111]; // 4 bytes here, rest through word lines 6-61
    /////////////////////// Word 6
    // ...
    /////////////////////// Word 61
    char c[4]; // 4 bytes
