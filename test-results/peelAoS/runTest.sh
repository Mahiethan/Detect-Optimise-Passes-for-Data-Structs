...
clang -emit-llvm unpeeled.c -fno-discard-value-names -S -o unoptimised.ll #produce IR

opt -load-pass-plugin=../DCSBatch/allPasses.so -passes="peel+reorderAoS" -time-passes < unoptimised.ll > optimised.bc #apply compiler passes
